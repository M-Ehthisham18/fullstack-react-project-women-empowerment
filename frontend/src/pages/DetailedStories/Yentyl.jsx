  ...
  return (
    <>
      ...
      <section className="max-w-[1000px] m-auto max-lg:p-12 sm:p-4 p-2">
        ...
        Empowered by Mentorship: A Story of Inspiration from Brenda King MBE
        </h2>
        <div className=" sm:float-right p-4">
          <img
            src="https://images.squarespace-cdn.com/content/v1/5b0eae802714e595728cdab2/1529342466261-GD7F6VJH8PMGY9036BEA/Yentyl.jpg?format=750w"
            alt="img"
